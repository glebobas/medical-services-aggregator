...
export function CheckBoxes({ label, isChecked, onChange }) {
  ...
  return (
    <div className="flex flex-row content-center mt-2 items-center">
      <input type="checkbox" className="rounded w-[20px] h-[20px]" checked={checked} onChange={handleChange}/>
        ...
        {/*</label>*/}
      <label className="text-lg ml-2 font-normal leading-20 dark:text-blue-100">{label}</label>
    </div>
  );
}
