                ...
                <div className="relative mx-auto grid max-w-7xl grid-cols-1 ">
                  <div className="bg-gray-50 px-4 py-8 sm:py-12 sm:px-6 lg:px-8 xl:pl-12">
                    <div className="mt-6 text-sm font-medium">
                      <a className=" flex text-gray-600 transition duration-150 ease-in-out hover:text-gray-500">
                        Add a review
                      ...
                      <ul role="list" className="mt-6 space-y-6">
                        {rev?.map((post, index) => (
                          <li key={post.reviewId + index} className="flow-root">
                            <a className="-m-3 flex rounded-lg p-3 transition duration-150 ease-in-out hover:bg-gray-100">
